...
public class GuideBookChopperMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GuideBookChopperMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FuetcraftModMenus.GUIDE_BOOK_CHOPPER.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof GuideBookChopperMenu) {
