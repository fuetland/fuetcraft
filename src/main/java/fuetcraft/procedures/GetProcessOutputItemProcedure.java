...
public class GetProcessOutputItemProcedure {
	public static ItemStack execute(LevelAccessor world, double x, double y, double z) {
		if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetNormal)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetMining)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetExploration)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetCombat)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetSwimming)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetEspetec)) {
		...
		} else if ((getBlockNBTString(world, BlockPos.containing(x, y, z), FuetcraftModVariables.MapVariables.get(world).currentTypeOfFuet)).equals(FuetcraftModVariables.MapVariables.get(world).fuetExpired)) {
