...
public class FuetCombatGuideBookTooltipProcedure {
	public static String execute() {
		return (new ItemStack(FuetcraftModItems.FUET_COMBAT.get()).getDisplayName().getString()).substring(1, (int) ((new ItemStack(FuetcraftModItems.FUET_COMBAT.get()).getDisplayName().getString()).length() - 1)) + "\n" + "\n"
				...
				+ Component.translatable("gui.guide.book.fuet.effects").getString() + "\n" + Component.translatable("gui.guide.book.fuet.combat.effect.1").getString() + "\n" + Component.translatable("gui.guide.book.fuet.combat.effect.2").getString();
	}
}
