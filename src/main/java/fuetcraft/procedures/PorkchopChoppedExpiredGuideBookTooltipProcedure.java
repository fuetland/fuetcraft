...
public class PorkchopChoppedExpiredGuideBookTooltipProcedure {
	public static String execute() {
		return (new ItemStack(FuetcraftModItems.EXPIRED_PORKCHOP_CHOPPED.get()).getDisplayName().getString()).substring(1, (int) ((new ItemStack(FuetcraftModItems.EXPIRED_PORKCHOP_CHOPPED.get()).getDisplayName().getString()).length() - 1)) + "\n"
