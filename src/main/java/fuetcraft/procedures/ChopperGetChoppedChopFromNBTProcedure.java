...
public class ChopperGetChoppedChopFromNBTProcedure {
	public static ItemStack execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "currentTypeOfFuet")).equals(FuetcraftModVariables.MapVariables.get(world).fuetNormal)) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "currentTypeOfFuet")).equals(FuetcraftModVariables.MapVariables.get(world).fuetMining)) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "currentTypeOfFuet")).equals(FuetcraftModVariables.MapVariables.get(world).fuetExploration)) {
