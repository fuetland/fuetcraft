...
public class GuideBookFuetScreen extends AbstractContainerScreen<GuideBookFuetMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("fuetcraft:textures/screens/guide_book_fuet.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-32x32.png"), this.leftPos + 96, this.topPos + 68, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-combat-32x32.png"), this.leftPos + 41, this.topPos + 28, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-expired-32x32.png"), this.leftPos + 141, this.topPos + 30, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-exploring-32x32.png"), this.leftPos + 22, this.topPos + 87, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-mining-32x32.png"), this.leftPos + 77, this.topPos + 114, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-swimming-32x32.png"), this.leftPos + 162, this.topPos + 110, 0, 0, 32, 32, 32, 32);

		guiGraphics.blit(new ResourceLocation("fuetcraft:textures/screens/fuet-tarradellas-32x32.png"), this.leftPos + 193, this.topPos + 62, 0, 0, 32, 32, 32, 32);
	...
	public void init() {
		...
		imagebutton_arrowleft32x16 = new ImageButton(this.leftPos + 7, this.topPos + 7, 32, 16, 0, 0, 16, new ResourceLocation("fuetcraft:textures/screens/atlas/imagebutton_arrowleft32x16.png"), 32, 32, e -> {
			if (true) {
				FuetcraftMod.PACKET_HANDLER.sendToServer(new GuideBookFuetButtonMessage(0, x, y, z));
